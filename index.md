...
- [shmqueue](https://github.com/fwkrumm/shmqueue): An inter-process FIFO queue backed by a shared-memory ring buffer. Any process can attach by name — no object passing required. Uses shmlock for synchronization and msgpack for serialization, with an optional pickle fallback.
